...
function validar(frm) {
	...
	var f = new Date();
	fecha_hoy = f.getDate()+ "-" +f.getMonth()+ "-" + f.getFullYear();
	fecha_seleccionada=new Date(document.form1.txt_fecha.value);
	
     if ( validarFechaMenorActual(document.form1.txt_fecha.value)==true){
  		alert("La fecha seleccionada no puede ser anterior al dia de hoy"); 
       ...
       <td width="770" height="300" align="center" valign="middle"><table width="570" border="0" cellspacing="0" cellpadding="0">
           ...
           <table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
                   <tr>
                     ...
                     <tr>
                         <td height="30" colspan="2" align="left" valign="middle" class="etiquetas"><label><span class="titulopantalla">Turno para licencia de conducir</span></label></td>
                      </tr>
                      <tr>
                           <td width="70" align="left" valign="middle" class="etiquetas"><span class="style17 style1">Motivo:</span></td>
                           <td width="500" align="left" valign="middle"><label>
            ...
            <tr>
                           <td width="70" align="left" valign="middle" class="etiquetas"><span class="style17 style1">Fecha:</span></td>
                      <td width="500" align="left" valign="middle"><span class="style17">
                       ...
                       <tr>
                           <td width="70" align="left" valign="middle" class="etiquetas style1">Horario:</td>
                      <td width="500" align="left" valign="middle">
                      <div id="horarios">          </div>                      </td>
                       </tr>
                         <tr>
                           <td width="70" align="left" valign="middle" class="etiquetas style1">DNI :</td>
                           <td width="500" align="left" valign="middle"><input name="txt_documento" type="text" class="datos" id="txt_documento" tabindex="2" onKeyPress="return tabular(event,this)" size="15" maxlength="11"  /></td>
                       </tr>
                       <tr>
                           <td width="70" align="left" valign="middle" class="etiquetas style1">Apellido:</td>
                <td width="500" align="left" valign="middle"><span class="style17">
                         ...
                         <tr>
                           <td width="70" align="left" valign="middle" class="etiquetas style1">Nombre:</td>
                         <td width="500" align="left" valign="middle"><input name="txt_nombre" type="text" class="datos" id="txt_nombre" tabindex="2" onKeyPress="return tabular(event,this)" size="50" maxlength="50" /></td>
                       </tr>
                         <tr>
                           <td width="70" align="left" valign="middle" class="etiquetas style1">Telefono:</td>
                   <td width="500" align="left" valign="middle"><span class="style17">
                         <input name="txt_telefono" type="text" class="datos" id="txt_telefono" tabindex="3" onKeyPress="return tabular(event,this)"   size="50" maxlength="50" />
                           ...
                           <td width="70" align="left" valign="middle" class="etiquetas style1">E-Mail:</td>
                      <td width="500" align="left" valign="middle"><span class="style17">
                       ...
                       <tr>
                         <td width="70" height="40" align="left" valign="middle" class="etiquetas">&nbsp;</td>
                      <td width="500" height="40" align="left" valign="bottom"><label>
