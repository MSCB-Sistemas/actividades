    ...
    <form action="procesa_turno.php" method="POST" name="form1" id="form1" onSubmit="return validar(this)">
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <a href="../mod_principal/menu_principal.php"><button type="button" align="right" name="btnCancelaTurno" class="btn btn-danger btn-lg" style="top:5px;">Cancelar</button></a>
