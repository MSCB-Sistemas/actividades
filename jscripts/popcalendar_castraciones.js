...
//    email :    fuushikaden <at> yahoo <dot> com
    ...
    */
    ...
    var    styleLightBorder="border-style:solid;border-width:1px;border-color:#0080C0;"
...
//CORROBORO SI LA FECHA ES VALIDA ES DECIR SI NO ES ANTERIOR A HOY O FERIADO
if (yearSelected > 2018 ||	validarFechaMenorActual(fecha_seleccionada)==true
						|| fecha_seleccionada=="12-02-2018" || fecha_seleccionada=="13-02-2018"
						...
						|| fecha_seleccionada=="31-12-2018") //SI SELECCIONAN UNA FECHA ANTERIOR A HOY, PONGO LA FECHA DE HOY
{
		...
		ctlToPlaceValue.value ="" //ctlToPlaceValue.value ES EL COMPONENTE DONDE SE MUESTRA LA FECHA
		document.getElementById("combo_horario").innerHTML = "";//VACIO EL COMBO DE HORARIOS
}
else
{
		//CORROBORO SI ES CANINO O FELINO
		if (document.form1.txt_especie.value == 'Canino'){
			if (dia_semana(fecha_seleccionada)==1 || dia_semana(fecha_seleccionada)==2 || dia_semana(fecha_seleccionada)==5 || dia_semana(fecha_seleccionada)==7) //ESTABLEZCO LOS DIAS DE LA SEMANA QUE NO ESTAN PERMITIDOS
			{
				alert('Las castraciones de caninos solo se realizan los dias Martes, Miércoles y viernes')
				
				ctlToPlaceValue.value ="" //ctlToPlaceValue.value ES EL COMPONENTE DONDE SE MUESTRA LA FECHA
				
				document.getElementById("combo_horario").innerHTML = "";
		...
		}//FIN SI ES CANINO O FELINO
}//FIN SI LA FECHA ES VALIDA ES DECIR SI NO ES ANTERIOR A HOY O FERIADO
    ...
    function constructMonth() {
        ...
        if (!monthConstructed) {
            ...
            document.getElementById("selectMonth").innerHTML = "<table width=100    style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#0080C0; background-color:#ffffff;' bgcolor='#FFFFFF' cellspacing=0 onmouseover='clearTimeout(timeoutID1)'    onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\", 100);event.cancelBubble=true'>" +    sHTML +    "</table>"
    ...
    function constructYear() {
        ...
        if (!yearConstructed) {
            ...
            document.getElementById("selectYear").innerHTML    = "<table width=44 style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#0080C0; background-color:#ffffff;'    bgcolor='#FFFFFF' onmouseover='clearTimeout(timeoutID2)' onmouseout='clearTimeout(timeoutID2);timeoutID2=setTimeout(\"popDownYear()\", 100)' cellspacing=0>"    + sHTML    + "</table>"
