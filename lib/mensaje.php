 ...
 <tr>
  ...
  <tr>
    <td bgcolor="#E7DAC7"><table width="770" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="30" align="left" valign="middle" bgcolor="#D3DBE2" class="titulopantalla"><?php echo utf8_encode($mensaje);?></td>
      </tr>
      <tr>
        <td height="30" align="left" valign="middle" bgcolor="#D3DBE2" class="titulopantalla">&nbsp;</td>
      </tr>
      <tr>
        <td height="30" align="left" valign="middle" bgcolor="#D3DBE2"><a href="<?php echo $destino;?>" class="enlace">Continuar &gt;&gt;</a></td>
      </tr>
    </table></td>
  </tr>
</table>
