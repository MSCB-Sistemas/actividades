...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <form action="bandeja_entrada.php" method="post" name="form1" id="form1">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-2">
								<a href="bandeja_entrada_excel.php?txt_fecha_desde=<?php echo $fecha_desde ?>&txt_fecha_hasta=<?php echo $fecha_hasta ?>" class="btn btn-success w-100">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table id="tabla_expedientes" class="table table-striped table-bordered table-hover table-sm w-100">
                        <thead>
                            <tr>
